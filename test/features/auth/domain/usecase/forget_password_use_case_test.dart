...
void main() {
  ...
  group("Forget Password Usecase", (){
    ...
    final failureResponse=ApiErrorResult<ForgetPasswordResponse>("There is no account with this email address  @1elevate.com");
...
verify(mockAuthRepository.forgetPassword(request)).called(1);
    ...
    test("should call ApiErrorResult when repo return success",
        ()async{
      when(mockAuthRepository.forgetPassword(request))
