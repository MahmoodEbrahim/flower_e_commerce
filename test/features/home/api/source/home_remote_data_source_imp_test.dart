...
void main() {
  ...
  setUpAll(() {
    ...
    fakeProductList = [
      ...
      ProductModel(
        ...
        priceAfterDiscount: 199,
        quantity: -1,
        category: "673c46fd1159920171827c86",
        occasion: "673b35c01159920171827aed",
        isSuperAdmin: true,
        sold: 101,
      ),
  ...
  group("test getProductsByCategoryId in homeRemoteDataSourceImp", () {
    test(
      ...
      () async {
        ...
        //act
        final res = await homeRemoteDataSourceImp.getProductsByCategoryId(
          catId,
        );
  ...
  group("test getSearchProducts in homeRemoteDataSourceImp", () {
    test(
      "when call getSearchProducts with catedgory not equal null and filter as a parameters it should return successApiResult",
      () async {
        // arrange
    ...
    test(
      "when call getSearchProducts with catedgory equal null and filter as a parameters it should return successApiResult",
      () async {
        // arrange
    ...
    test(
      "when call getSearchProducts with its paramentes should return failedApiResult with dio exception ",
      () async {
    ...
    test(
      "when call getSearchProducts with its paramenters it should return failedApiResult with exception ",
      () async {
           String filter = "price";
        String? catId;
        //arrange
        ...
        //act
        final res = await homeRemoteDataSourceImp.getSearchProducts(filter,
          catId,
        );
