...
void main() {
  ...
  group(' test GetProductsByCategoryIdUseCase', () {
    ...
    test(
        'when call getProductsByCategoryId in GetProductsByCategoryIdUseCase and remote source returns products, should return ApiSuccessResultl',
        () async {
      // arrange
      final mockResult =
    ...
    test(
      ...
      // arrange
      final mockFailure =
          ApiFailedResult<List<ProductsEntity>>("Error occurred");
