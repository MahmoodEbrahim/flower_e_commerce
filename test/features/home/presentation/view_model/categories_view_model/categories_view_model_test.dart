...
@GenerateMocks([GetProductsByCategoryIdUseCase, GetSearchProductsUsecase])
void main() {
  late MockGetProductsByCategoryIdUseCase mockGetProductsByCategoryIdUseCase;
  late MockGetSearchProductsUsecase mockGetSearchProductsUsecase;
  ...
  setUpAll(() {
    ...
    mockGetSearchProductsUsecase = MockGetSearchProductsUsecase();
