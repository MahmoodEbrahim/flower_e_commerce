...
void main() {
  ...
  group("test getProductsByCategoryId in HomeRepositoryImp", () {
    ...
    test(
      ...
      () async {
        // arrange
        final mockError = ApiFailedResult<List<ProductsEntity>>(
          "Network error",
        );
  ...
  group("test getSearchProducts in HomeRepositoryImp", () {
    test(
      "when call getSearchProducts in HomeRepositoryImp  with catId and filter  as a parameters it should return api sucess result ",
      () async {
        // arrang
        final mockResult = ApiSucessResult<List<ProductsEntity>>(
          fakeProductsModel,
    ...
    test(
      "when call getSearchProducts in HomeRepositoryImp  with catId null and filter  as a parameters it should return api sucess result ",
      () async {
        // arrang
        String? catId;
        final mockResult = ApiSucessResult<List<ProductsEntity>>(
    ...
    test(
      "when call getSearchProducts in HomeRepositoryImp and remote source returns failure, should return ApiFailureResult",
      () async {
        // arrange
        final mockError = ApiFailedResult<List<ProductsEntity>>(
          "Network error",
