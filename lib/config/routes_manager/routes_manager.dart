...
static List<CategoryModel> fakeCategories = [
  CategoryModel(
...
static List<ProductModel> fakeProducts = [
  ...
  ProductModel(
    ...
    slug: "red-pink-roses",
    description: "Beautiful arrangement of red and pink roses, ideal for anniversaries and romantic gestures.",
  ...
  ProductModel(
    ...
    description: "A cheerful bouquet of sunflowers, perfect for brightening up any space.",
  ...
  ProductModel(
    ...
    description: "Elegant orchids in a stylish arrangement, ideal for corporate gifts or home decor.",
  ...
  ProductModel(
    ...
    slug: "tulip-spring-mix",
    description: "Vibrant tulips in assorted colors, bringing the freshness of spring indoors.",
  ...
  ProductModel(
    ...
    description: "A calming bouquet of lavender, perfect for relaxation and home decor.",
  ...
  static Route onGenerate(RouteSettings settings) {
    ...
    switch (url.path) {
      ...
      case AppRoutes.catergories:
        return MaterialPageRoute(builder: (context) =>  CategoriesPage(categoryList: fakeCategories,produdctsList: fakeProducts,));
      default:
