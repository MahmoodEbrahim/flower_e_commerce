...
import '../../features/auth/api/source/auth_remote_data_souce_imp.dart'
    as _i669;
import '../../features/auth/api/source/user_local_storage_imp.dart' as _i75;
...
import '../../features/auth/data/source/user_local_storage.dart' as _i848;
...
import '../../features/profile/domain/repository/profile_repository.dart'
    as _i364;
import '../../features/profile/domain/usecase/generate_json_section_usecase.dart'
    as _i276;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.factory<_i530.JsonLoader>(() => _i530.AssetJsonLoader());
    gh.lazySingleton<_i848.UserLocalStorage>(() => _i75.UserLocalStorageImp());
    ...
    gh.lazySingleton<_i34.TokenInterceptor>(
        () => dioModule.tokenInterceptor(gh<_i848.UserLocalStorage>()));
    ...
    gh.factory<_i777.AuthRemoteDataSource>(() => _i669.AuthRemoteDataSourceImp(
          gh<_i522.AuthApiService>(),
          gh<_i848.UserLocalStorage>(),
        ));
    ...
    gh.factory<_i276.GenerateJsonSectionsUseCase>(
        () => _i276.GenerateJsonSectionsUseCase(gh<_i364.ProfileRepository>()));
    ...
    gh.factory<_i640.UserSessionBloc>(() => _i640.UserSessionBloc(
          gh<_i961.AuthRepository>(),
          gh<_i848.UserLocalStorage>(),
        ));
    gh.factory<_i207.ChangePasswordBloc>(
        () => _i207.ChangePasswordBloc(gh<_i568.GetChangePasswordUseCase>()));
    gh.factory<_i644.LoginBloc>(() => _i644.LoginBloc(
          gh<_i911.LoginUsecase>(),
          gh<_i640.UserSessionBloc>(),
          gh<_i848.UserLocalStorage>(),
        ));
    ...
    gh.factory<_i147.GenericJsonSectionBloc>(() =>
        _i147.GenericJsonSectionBloc(gh<_i276.GenerateJsonSectionsUseCase>()));
