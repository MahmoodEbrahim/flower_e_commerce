...
return   Scaffold(
    ...
    body: Padding(padding: EdgeInsetsGeometry.symmetric(horizontal: 24.0),
        child:Form(
          key: formKey,
          child:    Column(
            children: [
...
ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(local.passwordChangeSuccessfuly)));
